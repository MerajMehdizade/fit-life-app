      ...
      <div className="relative mt-12 max-w-lg sm:mt-10">
        ...
        <div
          ...
          <div className="flex flex-col p-6" dir="rtl">
            <h3 className="text-xl leading-6 tracking-tighter font-yekanBakhBlack">ثبت نام</h3>
            <p className="mt-2 text-sm text-white/50">خوش آمدید، برای ادامه اطلاعات ورود خود را وارد کنید.
            </p>
          </div>
