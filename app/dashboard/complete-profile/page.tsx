    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-black via-gray-900 to-black p-4">
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div className="bg-gray-900 rounded-2xl p-6 max-w-xs w-full text-center border border-gray-700 shadow-2xl">
            <h2 className="text-lg font-bold mb-4 text-white">آیا مطمئن هستید؟</h2>
